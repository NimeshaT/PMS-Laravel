                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Name</th><th>Image</th><th>Price</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($items as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->name }}</td><td><img src="{{ asset($item->image) }}" class="img img-responsive" width="50"/></td><td>{{ $item->price }}</td>
                                        <td>
